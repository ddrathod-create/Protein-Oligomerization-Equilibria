...
/* ── Symbol + description on the same line ── */
.param-row {
    display: flex;
...
.param-row .sidebar-input-label {
    margin-bottom: 0 !important;
    white-space: nowrap;
    flex-shrink: 0;
}
.param-row .eq-caption {
    margin: 0 !important;
    display: inline;
}
...
.custom-github-link svg {
    width: 22px;
    height: 22px;
    fill: #ffffff;
    transition: fill 0.15s;
}
.custom-github-link:hover svg {
    fill: #e040fb;
}
</style>

<a class="custom-github-link" href="https://github.com/ddrathod-create/FCS-Protein-Oligomerization-Equilibria" target="_blank" rel="noopener noreferrer" title="View source on GitHub">
